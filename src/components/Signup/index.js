    ...
    <div className="signup">
      <div className="testing1">
        <form className="signup-left" onSubmit={handleSubmit}>
          ...
          <div>
            <input type="checkbox" name="condition" id="condition" required /> <a className="signup-left-label" href="/terms" target="_blank">Accepter les conditions d'utilisation</a>
          </div>
