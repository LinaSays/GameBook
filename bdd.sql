...
(1,	'Contes pour enfants',	'https://cache.magicmaman.com/data/photo/w1000_ci/4w/contes-pour-enfant.jpg',	'Il est l\'heure de partir visiter le monde de l\'imagination, pour cela il est conseillé de se munir de sa plus belle voix de narrateur et d\'arriver à tenir en haleine c\'est chères têtes blondes.'),
(2,	'Heroïc Fantasy',	'https://wallpaperplay.com/walls/full/a/5/3/102151.jpg',	'Vos pouvoirs n\'ont comme limites que celles de votre imagination. Affrontez vos peurs, dominez la magie qui vous entoure mais attention à en sortir vivant sinon tout cela n\'aura été pour rien...'),
(3,	'Polar',	'https://www.maxpixel.net/static/photo/1x/Crime-Scene-Police-Forensics-Miniatures-Murder-3284258.jpghttps://api-lesondier.imgix.net/ac9cf0cf-8bc7-4e7b-8e80-13b8e299c63c.jpg',	'Enquêtes, crimes, suspicions et trahisons peuplent ce sombre univers. Temps pour vous de vous faufiler dans la peau d\'un détective hors pair si vous voulez avoir une chance de résoudre ces mystères.'),
(4,	'Science Fiction',	'http://logrelitteraire.fr/Critiques/wp-content/uploads/2015/07/plan%C3%A8te.jpg',	'Le futur vous entoure et il est devenu votre présent. Aventures aux confins de l\'espace et de l\'espèce, les limites de vos possibilités s\'amenuisent grâce aux dernières avancées technologiques.'),
(5,	'Horreur',	'https://images.radio-canada.ca/q_auto,w_1250/v1/ici-info/16x9/the-nun-film-horreur-publicite-video-effrayante.png',	'Aucune idée de ce qui se trouve derrière cette porte, peu de gens en sont revenus. Entrez à vos risques et périls.')
...
(15,	'Vous êtes paré(e) pour créer votre compte ici afin de pouvoir profiter de plus d’histoires à lire et qui sait pourquoi ne pas écrire la vôtre.',	7,	NULL,	'2019-10-29 13:04:07',	NULL),
